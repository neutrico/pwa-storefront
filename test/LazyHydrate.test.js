...
describe('LazyHydrate', () => {
  ...
  describe('on the server', () => {
    beforeEach(() => {
      jest.isolateModules(() => {
        isBrowser = jest.doMock('pwa-storefront/utils/isBrowser', () => () => false)
        const mod = require('pwa-storefront/LazyHydrate')
  ...
  describe('in the browser', () => {
    ...
    beforeEach(() => {
      jest.isolateModules(() => {
        events = {}
        isBrowser = jest.doMock('pwa-storefront/utils/isBrowser', () => () => true)
        ...
        jest.doMock('pwa-storefront/hooks/useIntersectionObserver', () => {
